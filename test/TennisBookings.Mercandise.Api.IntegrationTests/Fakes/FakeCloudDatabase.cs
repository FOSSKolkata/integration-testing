...
namespace TennisBookings.Mercandise.Api.IntegrationTests.Fakes
{
    public class FakeCloudDatabase : ICloudDatabase
    {
        ...
        {
            var fakeCloudDatabase = new FakeCloudDatabase();
            fakeCloudDatabase.ResetDefaultProducts();
            return fakeCloudDatabase;
        }
    }
}
