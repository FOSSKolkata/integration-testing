...
using TennisBookings.Mercandise.Api.IntegrationTests;
...
{
    public class ProductsControllerTests : IClassFixture<CustomWebApplicationFacotry<Startup>>
    {
        private readonly HttpClient _client;
        private readonly CustomWebApplicationFacotry<Startup> _factory;

        public ProductsControllerTests(CustomWebApplicationFacotry<Startup> factory)
        {
        ...
        public async Task Post_WithoutName_ReturnsExpectedProblemDetails(TestProductInputModel productInputModel,
        ...
        [Fact]
        public async Task Post_WithExisitingProductId_ReturnsConflict_WithExpectedLocation()
        {
        ...
        public async Task Post_AfterPostingValidProduct_ItCanBeRetrieved()
        {
            ...
            var getReponse = await _client.GetAsync(response.Headers.Location.ToString());
            getReponse.EnsureSuccessStatusCode();
        }
